        ...
        <header className="app-header morph-header">
          <nav className="desktop-nav radio-inputs">
            <button
              ...
              onClick={() => switchStyle("glass", "tone-soft")}
            >
              Glass
            </button>
            <button
              className="btn-primary"
              onClick={() => switchStyle("neumo", "tone-light")}
            >
              Neumo
            </button>
            <button
              className="btn-primary"
              onClick={() => switchStyle("clay", "tone-vivid")}
            >
              Clay
            </button>
            <button
              className="btn-primary"
              onClick={() => switchStyle("dark", "tone-dark")}
            >
              Dark
            </button>
          </nav>
