...
describe("API Routes - Error Handling", () => {
  ...
  describe("Headers and Logging", () => {
    it("should log request headers on /health", async () => {
      ...
      expect(consoleStub.calledWith("SUCCESS: API v1.4 route was successfully hit!")).to.be.true;
      expect(consoleStub.calledWith(sinon.match("Request Headers:"))).to.be.true;
    });
    ...
    it("should log request headers on /", async () => {
      ...
      expect(consoleStub.calledWith("SUCCESS: API route was successfully hit!")).to.be.true;
      expect(consoleStub.calledWith(sinon.match("Request Headers:"))).to.be.true;
    });
  });
